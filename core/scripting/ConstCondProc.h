...
class ConstCondProcessor : public Visitor {
  ...
  public:
    ...
    // Visitors
    void visitEqual(NodeEqual& node) override { visitCondT(node); }
    void visitNot(NodeNot& node) override { visitCondT(node); }
    void visitSuperior(NodeSuperior& node) override { visitCondT(node); }
    void visitSupEqual(NodeSupEqual& node) override { visitCondT(node); }
    void visitAnd(NodeAnd& node) override { visitCondT(node); }
